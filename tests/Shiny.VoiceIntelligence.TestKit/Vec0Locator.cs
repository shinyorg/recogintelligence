...
/// <c>runtimes/&lt;rid&gt;/native</c> folder. Returns null when missing — callers <c>Skip</c> on CI that
/// hasn't provisioned it. (Shared verbatim with the face TestKit; the vec0 binary lives at
/// <c>tests/runtimes/&lt;rid&gt;/native</c> for both stacks.)
/// </summary>
